...
SandboxEDU คือแอปพลิเคชันการเรียนรู้แบบปรับตัวเฉพาะบุคคล ที่ทำงานแบบ Offline พูดง่ายๆ คือเป็นเหมือนติวเตอร์ส่วนตัวที่อยู่ในมือถือ และ ไม่จำเป็นต้องใช้อินเทอร์เน็ต
